                    ...
                    <section className='recipe-content'>
                        <article>
                            <h4>instructions</h4>
                            {
                                instructions.map((item,i)=>{
                                    return <div key={i} className="single-instruction">
                                        <header>
                                            <p>step {i + 1}</p>
                                            <div></div>
                                        </header>
                        ...
                        <article className='second-column'>
                            <div>
                                <h4>ingredients</h4>
                                {
                                    ingredients.map((item,i)=>{
                                        return <p key={i} className="single-ingredient">
                                            {item}
                                        </p>
                                    })
                                }
                            ...
                            <div>
                                ...
                                {
                                    tools.map((item,i)=>{
                                        return <p key={i} className="single-tool">
                                            {item}
                                        </p>
                                    })
                                }
...
export const query = graphql`
    query getSingRecipe($title: String) {
